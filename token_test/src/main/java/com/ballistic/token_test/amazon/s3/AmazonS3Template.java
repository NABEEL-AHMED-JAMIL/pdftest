...
public class AmazonS3Template {
     ...
     * @param file is the file that will be save
     * @return an instance of {@link com.amazonaws.services.s3.model.PutObjectResult} containing the result fo the save operation
     *
     * */
